<template>
  <main v-if="user" class="page-shell">
      ...
      >
        <div class="flex items-center gap-4">
          ...
          <div class="space-y-2">
            ...
            <div>
              <h1 class="page-title !max-w-none !text-3xl sm:!text-4xl">
                {{ user.nickname }}
              </h1>
        ...
        <RouterLink class="btn-secondary" to="/me/account"
          >编辑账号信息</RouterLink
        >
      </div>
    </section>
    ...
    <section class="mt-6 grid gap-4">
      <RouterLink
        class="surface-card flex items-center justify-between gap-4"
        to="/me/record"
      >
        <div class="space-y-1">
          <div class="section-title">人物档案</div>
